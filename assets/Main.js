...
function createInstructions() {
	...
	innerHTML[0] = '<span style="color:' + theme[0] + ';font-size:26px;"></span><br /><span style="font-size:20px;"><br />aaa<br />aaa<br />aaa<br />aaa</span>';
	innerHTML[1] = '<span style="color:' + theme[0] + ';font-size:26px;"></span><br /><span style="font-size:20px;"><br />bbb<br />aaa<br />aaa<br />aaa</span>';
	innerHTML[2] = '<span style="color:' + theme[0] + ';font-size:26px;"></span><br /><span style="font-size:20px;"><br />ccc<br />aaa<br />aaa<br />aaa</span>';
	innerHTML[3] = '<span style="color:' + theme[0] + ';font-size:26px;"></span><br /><span style="font-size:20px;"><br />你站在桥上看风景<br />看风景的人在楼上看你<br />明月装饰了你的窗子<br />你装饰了别人的梦</span>';
	text.innerHTML = innerHTML[Math.floor(Math.random()*4)];
